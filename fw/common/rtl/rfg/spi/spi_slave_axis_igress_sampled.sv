...
*/
module spi_slave_axis_igress_sampled #( 
    ...
    parameter MSB_FIRST     = 1  ) (
        ...
        // Async reset
        input  wire                         spi_clk, // when 1 do something - to be set to edge or falling edge by user
        input  wire                         spi_selected, // When 1 do something - to be set by user depending on the edge sensitibity
        input  wire                         spi_mosi,
